...
___**PART**__ 1 pt: The `Library` class implements the requested additional methods (`containsTitle(...)`, `isAvailable(...)`, and `printCollection()`)
...
___**PART**__ 4 pts: Programs compile without errors or warnings
